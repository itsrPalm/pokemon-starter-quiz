...
// 	<div className="absolute z-10 p-2 bg-white rounded shadow-lg text-sm w-64">
...
// 				canGoBack ? "bg-blue-500 hover:bg-blue-600" : "bg-gray-300"
// 			} text-white`}
// 		>
// 			Back
// 		</button>
...
// 	const [finalGrass, setFinalGrass] = useState<Pokemon[]>([]);
// 	const [finalFire, setFinalFire] = useState<Pokemon[]>([]);
// 	const [finalWater, setFinalWater] = useState<Pokemon[]>([]);
...
// 				setFinalGrass([
// 					newRemaining[0],
// 					...remainingGrass.filter((_, i) => i !== index),
// 				]);
// 				setStage("fire");
// 				playStageAudio("fire");
// 			} else if (type === "fire") {
// 				setFinalFire([
// 					newRemaining[0],
// 					...remainingFire.filter((_, i) => i !== index),
// 				]);
// 				setStage("water");
// 				playStageAudio("water");
// 			} else {
// 				setFinalWater([
// 					newRemaining[0],
// 					...remainingWater.filter((_, i) => i !== index),
// 				]);
// 				setStage("result");
// 				if (legendAudioRef.current) {
// 					legendAudioRef.current.pause();
...
// 		if (lastElimination.type === "grass") {
// 			setRemainingGrass([...remainingGrass, lastElimination.pokemon]);
// 		} else if (lastElimination.type === "fire") {
// 			setRemainingFire([...remainingFire, lastElimination.pokemon]);
// 		} else {
// 			setRemainingWater([...remainingWater, lastElimination.pokemon]);
// 		}
// 	};
...
// 	const handleForward = () => {
// 		if (stage === "grass" && finalGrass.length > 0) {
// 			setStage("fire");
// 			playStageAudio("fire");
// 		} else if (stage === "fire" && finalFire.length > 0) {
// 			setStage("water");
// 			playStageAudio("water");
// 		} else if (stage === "water" && finalWater.length > 0) {
// 			setStage("result");
// 			if (legendAudioRef.current) {
// 				legendAudioRef.current.pause();
// 			}
...
// 						exit={{ opacity: 0, y: -50 }}
// 						transition={{ duration: 0.5, delay: index * 0.1 }}
// 						className={`flex flex-col items-center ${styles.background} ${styles.border} border shadow-md rounded-lg p-4 relative`}
// 						whileHover={{
// 							scale: 1.05,
// 							boxShadow: "0px 0px 8px rgb(0,0,0,0.2)",
// 						}}
...
// 								<button
// 									onClick={handleUndo}
// 									disabled={eliminationHistory.length === 0}
// 									className={`px-4 py-2 rounded ${
...
// broken state logic (undo brings back eliminates in previous stage)
// "use client";
...
// const Tooltip = ({ content }: { content: string[] }) => (
// 	<div className="absolute z-20 p-2 bg-white rounded shadow-lg text-sm w-64 left-full ml-2 top-0">
// 		<ul className="list-disc pl-4">
// 			{content.map((item, index) => (
// 				<li key={index}>{item}</li>
// 			))}
...
// 			if (type === "grass") {
// 				setFinalGrass(newRemaining);
// 				setStage("fire");
// 				playStageAudio("fire");
// 			} else if (type === "fire") {
// 				setFinalFire(newRemaining);
// 				setStage("water");
// 				playStageAudio("water");
// 			} else {
// 				setFinalWater(newRemaining);
// 				setStage("result");
// 				if (legendAudioRef.current) {
// 					legendAudioRef.current.pause();
// 				}
...
// 			setStage("grass");
// 			setFinalGrass([]);
// 			setRemainingGrass(grassPokemon);
// 			playStageAudio("grass");
// 		} else if (stage === "water") {
// 			setStage("fire");
// 			setFinalFire([]);
// 			setRemainingFire(firePokemon);
// 			playStageAudio("fire");
// 		}
// 	};
...
// 							{showTooltip === index && (
// 								<Tooltip
// 									content={pokemon.detailedDescription}
// 								/>
// 							)}
// 						</div>
...
// const Tooltip = ({ content }: { content: string[] }) => (
// 	<div className="absolute z-50 p-2 bg-white rounded shadow-lg text-sm w-64 left-full ml-2 top-0">
// 		<ul className="list-disc pl-4">
// 			{content.map((item, index) => (
// 				<li key={index}>{item}</li>
// 			))}
...
// 		if (type === "grass") {
// 			setRemainingGrass([...remainingGrass, pokemon]);
// 			if (finalGrass.length === 3) {
// 				setFinalGrass(finalGrass.filter((p) => p !== pokemon));
// 				setStage("grass");
// 			}
// 		} else if (type === "fire") {
// 			setRemainingFire([...remainingFire, pokemon]);
// 			if (finalFire.length === 3) {
// 				setFinalFire(finalFire.filter((p) => p !== pokemon));
// 				setStage("fire");
// 			}
// 		} else {
// 			setRemainingWater([...remainingWater, pokemon]);
// 			if (finalWater.length === 3) {
// 				setFinalWater(finalWater.filter((p) => p !== pokemon));
// 				setStage("water");
// 			}
// 		}
// 	};
...
// 	const handleForward = () => {
// 		if (stage === "grass" && finalGrass.length === 3) {
// 			setStage("fire");
// 			playStageAudio("fire");
// 		} else if (stage === "fire" && finalFire.length === 3) {
// 			setStage("water");
// 			playStageAudio("water");
// 		} else if (stage === "water" && finalWater.length === 3) {
// 			setStage("result");
// 			if (legendAudioRef.current) {
// 				legendAudioRef.current.pause();
// 			}
...
// 	) => {
// 		const styles = getTypeStyles(type);
// 		const canEliminate = pokemonList.length > 3;
...
// const Tooltip = ({ content }: { content: string[] }) => (
// 	<div className="absolute z-[9999] p-2 bg-white rounded shadow-lg text-sm w-64 left-full ml-2 top-0">
// 		<ul className="list-disc pl-4">
// 			{content.map((item, index) => (
// 				<li key={index}>{item}</li>
// 			))}
