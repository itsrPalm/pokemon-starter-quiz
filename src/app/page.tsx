...
// 		const winners = getWinners();
// 		const allTypes = ["grass", "fire", "water"] as const;

// 		const sortedPokemon = allTypes
// 			.flatMap((type) =>
// 				winners[type].map((pokemon, index) => ({
// 					pokemon,
// 					type,
// 					rank:
// 						index === 0
...
// 			)
// 			.sort((a, b) => {
// 				if (a.rank === "Your Top Match!") return -1;
// 				if (b.rank === "Your Top Match!") return 1;
// 				if (a.rank === "Runner Up") return -1;
// 				if (b.rank === "Runner Up") return 1;
// 				return 0;
// 			});
...
// 					{sortedPokemon.map(({ pokemon, type, rank }, index) => (
// 						<PokemonCard
// 							key={`${type}-${index}`}
// 							pokemon={pokemon}
// 							type={type}
...
// 		legendAudio: new Audio("/legend.mp3"),
// 		grassAudio: new Audio("/grass.mp3"),
// 		fireAudio: new Audio("/fire.mp3"),
// 		waterAudio: new Audio("/water.mp3"),
// 		eliminateAudio: new Audio("/eliminate.mp3"),
// 		sendingOffAudio: new Audio("/sending-off.mp3"),
// 	});
...
// 		if (audioRefs.current.eliminateAudio) {
// 			audioRefs.current.eliminateAudio
// 				.play()
// 				.catch((error) =>
// 					console.error("Eliminate audio playback failed:", error)
// 				);
...
// 					playStageAudio(nextStage);
// 				} else {
// 					if (audioRefs.current.legendAudio) {
// 						audioRefs.current.legendAudio.pause();
// 					}
// 					if (audioRefs.current.sendingOffAudio) {
// 						audioRefs.current.sendingOffAudio
// 							.play()
// 							.catch((error) =>
// 								console.error(
// 									"Sending-off audio playback failed:",
...
// 	const playStageAudio = (stageType: "grass" | "fire" | "water") => {
// 		const audioRef = {
// 			grass: audioRefs.current.grassAudio,
// 			fire: audioRefs.current.fireAudio,
// 			water: audioRefs.current.waterAudio,
// 		}[stageType];
...
// 							);
// 						} else {
// 							audioRefs.current.legendAudio
// 								.play()
// 								.catch((e) =>
// 									console.error(
// 										"Legend audio playback failed:",
// 										e
// 									)
// 								);
// 						}
...
// 								onClick={() => {
// 									setStage("grass");
// 									audioRefs.current.grassAudio.play();
// 								}}
// 								className="bg-yellow-400 hover:bg-yellow-500 text-black font-bold py-3 px-6 rounded-full text-xl mt-4"
// 								whileHover={{
// 									scale: 1.05,
...
// 		// const eliminateAudio = audioRefs.current.eliminateAudio;
// 		// eliminateAudio
// 		// 	.play()
// 		// 	.catch((error) =>
// 		// 		console.error("Eliminate audio playback failed:", error)
...
// 		// Include the 'image' property in the prepared Pokémon data
// 		const preparePokemons = (pokemons: Pokemon[]) =>
// 			pokemons.map(({ name, description, traits, image }) => ({
// 				name,
// 				description,
// 				traits,
// 				image, // Ensure the image URL is included
// 			}));
...
// 			{/* Bottom red border to keep visibility when closed */}
// 			<path
// 				d="M5,50 a1,1 0 0,0 90,0"
// 				fill="#ff1a1a"
...
// 			{/* Red half-circle (mirrored to appear on top) */}
// 			<path
// 				d="M5,50 a1,1 0 0,1 90,0" // Changed from '0 0,0' to '0 0,1' to mirror
// 				fill="#ff1a1a"
// 				className={`transition-transform duration-1000 ${
// 					isOpen ? "translate-y-[-25px] rotate-[-25deg]" : ""
// 				}`}
...
// 			{/* Center black circle (should always be on top) */}
// 			<circle
// 				cx="50"
// 				cy="50"
// 				r="12"
...
// 			{/* Red half-circle */}
// 			<path
// 				d="M5,50 a1,1 0 0,1 90,0" // Adjusted to mirror red half-circle on top
// 				fill="#ff1a1a"
...
// 	return (
// 		<div className={`${getCardStyle(rank)} mb-8`}>
// 			<div
// 				className={`flex flex-col ${getTypeStyles(type).background} ${
// 					getTypeStyles(type).border
// 				} border shadow-md rounded-lg p-4 h-full overflow-hidden`}
// 			>
