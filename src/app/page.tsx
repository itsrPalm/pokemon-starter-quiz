...
// // // 		className="fixed inset-0 w-screen h-screen overflow-hidden bg-green-100"
// // // 	>
// // // 		{/* (SVG and motion.path for Grass Animation) */}
// // // 	</motion.div>
// // // );
...
// // // 		className="fixed inset-0 w-screen h-screen overflow-hidden bg-orange-100"
// // // 	>
// // // 		{/* (SVG and motion.path for Fire Animation) */}
// // // 	</motion.div>
// // // );
...
// // // 		className="fixed inset-0 w-screen h-screen overflow-hidden bg-blue-100"
// // // 	>
// // // 		{/* (SVG and motion.path for Water Animation) */}
// // // 	</motion.div>
// // // );
...
// // // 			// Check if three are left to determine final 3 for ranking
// // // 			if (newRemaining.length === 3) {
// // // 				if (type === "grass") {
// // // 					setFinalGrass(newRemaining);
// // // 					setStage("fire");
...
// // 			// Move to the next stage only after three Pokémon remain for ranking
// // 			if (newRemaining.length === 3) {
// // 				if (type === "grass") {
// // 					setFinalGrass(newRemaining);
// // 					playStageAudio("fire");
...
// 	const rankOrder = (type: string, finalThree: Pokemon[]) => {
// 		const lastTwoEliminations = eliminationHistory
// 			.filter((entry) => entry.type === type)
// 			.slice(-2)
// 			.map((entry) => entry.pokemon);

// 		const remainingPokemon = finalThree.filter(
// 			(pokemon) => !lastTwoEliminations.includes(pokemon)
// 		)[0];

// 		return [remainingPokemon, ...lastTwoEliminations];
// 	};
...
// 							<div className="flex flex-wrap justify-center gap-4 mt-6">
// 								{[
// 									...rankOrder("grass", finalGrass),
// 									...rankOrder("fire", finalFire),
// 									...rankOrder("water", finalWater),
// 								].map((pokemon, index) => {
// 									const type =
// 										index < 3
// 											? "grass"
