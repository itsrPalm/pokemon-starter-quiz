...
// /** Constants */
// const hexColors: Record<PokemonType, string> = {
// 	grass: "#78C850",
// 	fire: "#F08030",
// 	water: "#6890F0",
// };
...
// /** Size and Style Helper Functions */
// const getCardStyle = (type: PokemonType): string => {
// 	return typeStyles[type].background;
// };
...
// /** Pixelation Types and Interfaces */
...
// type DitherMatrix = number[][];
// type RGBColor = [number, number, number];

// /** Pixelation Utility Functions */
// const getBayerMatrix = (size: string): DitherMatrix => {
// 	switch (size) {
// 		case "4x4":
// 			return [
// 				[0, 8, 2, 10],
...
// const pixelate = async (options: PixelateOptions): Promise<string> => {
// 	const {
// 		image,
// 		width,
// 		dither = "none",
...
// 	if (palette) {
// 		const rgbPalette: RGBColor[] = palette.map((hex) => {
// 			const r = parseInt(hex.substr(1, 2), 16);
// 			const g = parseInt(hex.substr(3, 2), 16);
// 			const b = parseInt(hex.substr(5, 2), 16);
// 			return [r, g, b];
...
// const applyRandomPixelation = async (imageBase64: string): Promise<string> => {
// 	try {
// 		const image = await base64ToImage(imageBase64);
...
// 			image,
// 			width: pixelSizes[Math.floor(Math.random() * pixelSizes.length)],
// 			dither: ditherTypes[Math.floor(Math.random() * ditherTypes.length)],
// 			strength: Math.floor(
// 				Math.random() * (strengthRange.max - strengthRange.min) +
// 					strengthRange.min
// 			),
// 			palette: DEFAULT_PALETTES[0].colors,
// 			resolution: "original",
...
// const Pokeball: React.FC<PokeballProps> = ({ isOpen, children, imageSize }) => (
// 	<div
// 		className="relative flex items-center justify-center"
// 		style={{
// 			width: `${imageSize}px`,
...
// 			// Send to get-hat-variants with pixelated version
// 			const response = await fetch("/api/get-hat-variants", {
// 				method: "POST",
// 				headers: { "Content-Type": "application/json" },
// 				body: JSON.stringify({
...
// 				// Apply pixelation to the PNG
// 				const pixelatedBase64 = await applyRandomPixelation(
// 					data.pngBase64
// 				);

// 				// Send to generate-pokemon-svg with the original pokemon object and separate pixelated image
// 				const generateResponse = await fetch(
// 					"/api/generate-pokemon-svg",
// 					{
// 						method: "POST",
...
// 					// Use original pokemon data with pixelated image
// 					const generateResponse = await fetch(
// 						"/api/generate-pokemon-svg",
// 						{
// 							method: "POST",
...
// 			// If no existing PNG, generate new one
// 			const svgResponse = await fetch("/api/generate-pokemon-svg", {
// 				method: "POST",
// 				headers: {
// 					"Content-Type": "application/json",
